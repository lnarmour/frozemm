#include <assert.h>
#include <stdio.h>
#include "star2d1r-128-15-1024_kernel.hu"
#define BENCH_DIM 2
#define BENCH_FPP 9
#define BENCH_RAD 1
...
#define AN5D_TYPE unsigned
      ...
      else if (__c0Len % __side0LenMax)
      {
        ...
        else if (__c0Len % __side0LenMax == 9)
        {
          ...
          const AN5D_TYPE __side1Len = 1024;
          const AN5D_TYPE __side2Len = 110;
          const AN5D_TYPE __OlLen1 = (__halo1 * __side0Len);
          const AN5D_TYPE __OlLen2 = (__halo2 * __side0Len);
          const AN5D_TYPE __side1LenOl = (__side1Len + 2 * __OlLen1);
          const AN5D_TYPE __side2LenOl = (__side2Len + 2 * __OlLen2);
        ...
        else if (__c0Len % __side0LenMax == 10)
        {
          ...
          const AN5D_TYPE __side1Len = 1024;
          const AN5D_TYPE __side2Len = 108;
          const AN5D_TYPE __OlLen1 = (__halo1 * __side0Len);
          const AN5D_TYPE __OlLen2 = (__halo2 * __side0Len);
          const AN5D_TYPE __side1LenOl = (__side1Len + 2 * __OlLen1);
          const AN5D_TYPE __side2LenOl = (__side2Len + 2 * __OlLen2);
        ...
        else if (__c0Len % __side0LenMax == 11)
        {
          ...
          const AN5D_TYPE __side1Len = 1024;
          const AN5D_TYPE __side2Len = 106;
          const AN5D_TYPE __OlLen1 = (__halo1 * __side0Len);
          const AN5D_TYPE __OlLen2 = (__halo2 * __side0Len);
          const AN5D_TYPE __side1LenOl = (__side1Len + 2 * __OlLen1);
          const AN5D_TYPE __side2LenOl = (__side2Len + 2 * __OlLen2);
        ...
        else if (__c0Len % __side0LenMax == 12)
        {
          ...
          const AN5D_TYPE __side1Len = 1024;
          const AN5D_TYPE __side2Len = 104;
          const AN5D_TYPE __OlLen1 = (__halo1 * __side0Len);
          const AN5D_TYPE __OlLen2 = (__halo2 * __side0Len);
          const AN5D_TYPE __side1LenOl = (__side1Len + 2 * __OlLen1);
          const AN5D_TYPE __side2LenOl = (__side2Len + 2 * __OlLen2);
        ...
        else if (__c0Len % __side0LenMax == 13)
        {
          ...
          const AN5D_TYPE __side1Len = 1024;
          const AN5D_TYPE __side2Len = 102;
          const AN5D_TYPE __OlLen1 = (__halo1 * __side0Len);
          const AN5D_TYPE __OlLen2 = (__halo2 * __side0Len);
          const AN5D_TYPE __side1LenOl = (__side1Len + 2 * __OlLen1);
          const AN5D_TYPE __side2LenOl = (__side2Len + 2 * __OlLen2);
        ...
        else if (__c0Len % __side0LenMax == 14)
        {
          ...
          const AN5D_TYPE __side1Len = 1024;
          const AN5D_TYPE __side2Len = 100;
          const AN5D_TYPE __OlLen1 = (__halo1 * __side0Len);
          const AN5D_TYPE __OlLen2 = (__halo2 * __side0Len);
          const AN5D_TYPE __side1LenOl = (__side1Len + 2 * __OlLen1);
          const AN5D_TYPE __side2LenOl = (__side2Len + 2 * __OlLen2);
