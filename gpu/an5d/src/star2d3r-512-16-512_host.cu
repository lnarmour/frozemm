#include <assert.h>
#include <stdio.h>
#include "star2d3r-512-16-512_kernel.hu"
#define BENCH_DIM 2
#define BENCH_FPP 25
#define BENCH_RAD 3
...
#define AN5D_TYPE unsigned
      ...
      AN5D_TYPE __side0LenMax;
      {
        ...
        const AN5D_TYPE __side2Len = 416;
        ...
        {
          {
            ...
            const AN5D_TYPE __side1Len = 512;
            const AN5D_TYPE __side2Len = 464;
            const AN5D_TYPE __OlLen1 = (__halo1 * __side0Len);
            const AN5D_TYPE __OlLen2 = (__halo2 * __side0Len);
            const AN5D_TYPE __side1LenOl = (__side1Len + 2 * __OlLen1);
            const AN5D_TYPE __side2LenOl = (__side2Len + 2 * __OlLen2);
      ...
      else if (__c0Len % __side0LenMax)
      {
        ...
        else if (__c0Len % __side0LenMax == 9)
        {
          ...
          const AN5D_TYPE __side1Len = 512;
          const AN5D_TYPE __side2Len = 458;
          const AN5D_TYPE __OlLen1 = (__halo1 * __side0Len);
          const AN5D_TYPE __OlLen2 = (__halo2 * __side0Len);
          const AN5D_TYPE __side1LenOl = (__side1Len + 2 * __OlLen1);
          const AN5D_TYPE __side2LenOl = (__side2Len + 2 * __OlLen2);
        ...
        else if (__c0Len % __side0LenMax == 10)
        {
          ...
          const AN5D_TYPE __side1Len = 512;
          const AN5D_TYPE __side2Len = 452;
          const AN5D_TYPE __OlLen1 = (__halo1 * __side0Len);
          const AN5D_TYPE __OlLen2 = (__halo2 * __side0Len);
          const AN5D_TYPE __side1LenOl = (__side1Len + 2 * __OlLen1);
          const AN5D_TYPE __side2LenOl = (__side2Len + 2 * __OlLen2);
        ...
        else if (__c0Len % __side0LenMax == 11)
        {
          ...
          const AN5D_TYPE __side1Len = 512;
          const AN5D_TYPE __side2Len = 446;
          const AN5D_TYPE __OlLen1 = (__halo1 * __side0Len);
          const AN5D_TYPE __OlLen2 = (__halo2 * __side0Len);
          const AN5D_TYPE __side1LenOl = (__side1Len + 2 * __OlLen1);
          const AN5D_TYPE __side2LenOl = (__side2Len + 2 * __OlLen2);
        ...
        else if (__c0Len % __side0LenMax == 12)
        {
          ...
          const AN5D_TYPE __side1Len = 512;
          const AN5D_TYPE __side2Len = 440;
          const AN5D_TYPE __OlLen1 = (__halo1 * __side0Len);
          const AN5D_TYPE __OlLen2 = (__halo2 * __side0Len);
          const AN5D_TYPE __side1LenOl = (__side1Len + 2 * __OlLen1);
          const AN5D_TYPE __side2LenOl = (__side2Len + 2 * __OlLen2);
        ...
        else if (__c0Len % __side0LenMax == 13)
        {
          ...
          const AN5D_TYPE __side1Len = 512;
          const AN5D_TYPE __side2Len = 434;
          const AN5D_TYPE __OlLen1 = (__halo1 * __side0Len);
          const AN5D_TYPE __OlLen2 = (__halo2 * __side0Len);
          const AN5D_TYPE __side1LenOl = (__side1Len + 2 * __OlLen1);
          const AN5D_TYPE __side2LenOl = (__side2Len + 2 * __OlLen2);
        ...
        else if (__c0Len % __side0LenMax == 14)
        {
          ...
          const AN5D_TYPE __side1Len = 512;
          const AN5D_TYPE __side2Len = 428;
          const AN5D_TYPE __OlLen1 = (__halo1 * __side0Len);
          const AN5D_TYPE __OlLen2 = (__halo2 * __side0Len);
          const AN5D_TYPE __side1LenOl = (__side1Len + 2 * __OlLen1);
          const AN5D_TYPE __side2LenOl = (__side2Len + 2 * __OlLen2);
        ...
        else if (__c0Len % __side0LenMax == 15)
        {
          ...
          const AN5D_TYPE __side1Len = 512;
          const AN5D_TYPE __side2Len = 422;
          const AN5D_TYPE __OlLen1 = (__halo1 * __side0Len);
          const AN5D_TYPE __OlLen2 = (__halo2 * __side0Len);
          const AN5D_TYPE __side1LenOl = (__side1Len + 2 * __OlLen1);
          const AN5D_TYPE __side2LenOl = (__side2Len + 2 * __OlLen2);
