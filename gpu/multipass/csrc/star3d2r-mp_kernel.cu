...
__global__ void kernel0_4(float *A, int dimsize, int timestep, int I, int J, int K, int c0)
{
#ifndef AN5D_TYPE
#define AN5D_TYPE unsigned
    ...
    #define __c0 c0
    const AN5D_TYPE __c1Len = (min(dimsize, I - 2) - 2);
    const AN5D_TYPE __c1Pad = (2);
    #define __c1 c1
    const AN5D_TYPE __c2Len = (min(dimsize, J - 2) - 2);
    const AN5D_TYPE __c2Pad = (2);
    #define __c2 c2
    const AN5D_TYPE __c3Len = (min(dimsize, K - 2) - 2);
...
__global__ void kernel0_3(float *A, int dimsize, int timestep, int I, int J, int K, int c0)
{
#ifndef AN5D_TYPE
#define AN5D_TYPE unsigned
#endif
...
__global__ void kernel0_2(float *A, int dimsize, int timestep, int I, int J, int K, int c0)
{
#ifndef AN5D_TYPE
#define AN5D_TYPE unsigned
#endif
...
__global__ void kernel0_1(float *A, int dimsize, int timestep, int I, int J, int K, int c0)
{
#ifndef AN5D_TYPE
#define AN5D_TYPE unsigned
#endif
