...
void one_strip(SB_TYPE *A1, int dimsize, int timestep) 
{
  ...
  // start --------------------------------------------------
    if (dimsize >= 3 && timestep >= 1 && I >= 5 && J >= 5 && K >= 5) {
...
#define AN5D_TYPE unsigned
      ...
      AN5D_TYPE __side0LenMax;
      {
        ...
        {
          kernel0_4<<<k0_dimGrid, k0_dimBlock>>> (dev_A, dimsize, timestep, I, J, K, c0);
        }
      }
        ...
        {
          {
            ...
            dim3 k0_dimBlock(__blockSize, 1, 1);
            dim3 k0_dimGrid(1 * ((__c1Len + __side1Len - 1) / __side1Len) * ((__c2Len + __side2Len - 1) / __side2Len) * ((__c3Len + __side3Len - 1) / __side3Len), 1, 1);
            kernel0_2<<<k0_dimGrid, k0_dimBlock>>> (dev_A, dimsize, timestep, I, J, K, c0);
          }
          c0 += 1;
          {
            const AN5D_TYPE __side0Len = 2;
        ...
        {
          {
            ...
            dim3 k0_dimBlock(__blockSize, 1, 1);
            dim3 k0_dimGrid(1 * ((__c1Len + __side1Len - 1) / __side1Len) * ((__c2Len + __side2Len - 1) / __side2Len) * ((__c3Len + __side3Len - 1) / __side3Len), 1, 1);
            kernel0_3<<<k0_dimGrid, k0_dimBlock>>> (dev_A, dimsize, timestep, I, J, K, c0);
          }
          c0 += 1;
          {
            ...
            dim3 k0_dimBlock(__blockSize, 1, 1);
            dim3 k0_dimGrid(1 * ((__c1Len + __side1Len - 1) / __side1Len) * ((__c2Len + __side2Len - 1) / __side2Len) * ((__c3Len + __side3Len - 1) / __side3Len), 1, 1);
            kernel0_1<<<k0_dimGrid, k0_dimBlock>>> (dev_A, dimsize, timestep, I, J, K, c0);
          }
          c0 += 1;
          {
            const AN5D_TYPE __side0Len = 1;
