#include "star3d2r-mp-32x9-2-20.P400_kernel.hu"
...
#define AN5D_TYPE unsigned
    ...
    #define __c0 c0
    const AN5D_TYPE __c1Len = (min(dimsize - 1, 400 * p + 399) - 400 * p + 1);
    const AN5D_TYPE __c1Pad = (400 * p);
    #define __c1 c1
    const AN5D_TYPE __c2Len = (min(dimsize - 1, 400 * p + 399) - 400 * p + 1);
    const AN5D_TYPE __c2Pad = (400 * p);
    #define __c2 c2
    const AN5D_TYPE __c3Len = (min(dimsize - 1, 400 * p + 399) - 400 * p + 1);
    const AN5D_TYPE __c3Pad = (400 * p);
    #define __c3 c3
    const AN5D_TYPE __halo1 = 2;
    const AN5D_TYPE __halo2 = 2;
    const AN5D_TYPE __halo3 = 2;
    const AN5D_TYPE __side0Len = 2;
    const AN5D_TYPE __side1Len = 20;
    const AN5D_TYPE __side2Len = 1;
