#include "star3d2r-mp-32x9-2-33.P100_kernel.hu"
...
#define AN5D_TYPE unsigned
    ...
    #define __c0 c0
    const AN5D_TYPE __c1Len = (min(dimsize - 1, 100 * p + 99) - 100 * p + 1);
    const AN5D_TYPE __c1Pad = (100 * p);
    #define __c1 c1
    const AN5D_TYPE __c2Len = (min(dimsize - 1, 100 * p + 99) - 100 * p + 1);
    const AN5D_TYPE __c2Pad = (100 * p);
    #define __c2 c2
    const AN5D_TYPE __c3Len = (min(dimsize - 1, 100 * p + 99) - 100 * p + 1);
    const AN5D_TYPE __c3Pad = (100 * p);
    #define __c3 c3
