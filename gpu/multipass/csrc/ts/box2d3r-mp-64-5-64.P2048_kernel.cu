#include "box2d3r-mp-64-5-64.P2048_kernel.hu"
__device__ float __sbref_wrap(float *sb, size_t index) { return sb[index]; }

__global__ void kernel0_5(float *A, int dimsize, int timestep, int p, int c0)
{
#ifndef AN5D_TYPE
...
__global__ void kernel0_3(float *A, int dimsize, int timestep, int p, int c0)
{
#ifndef AN5D_TYPE
#define AN5D_TYPE unsigned
#endif
...
__global__ void kernel0_2(float *A, int dimsize, int timestep, int p, int c0)
{
#ifndef AN5D_TYPE
#define AN5D_TYPE unsigned
#endif
...
__global__ void kernel0_1(float *A, int dimsize, int timestep, int p, int c0)
{
#ifndef AN5D_TYPE
#define AN5D_TYPE unsigned
#endif
