...
__global__ void kernel0_4(float *A, int dimsize, int timestep, int I, int J, int c0)
{
#ifndef AN5D_TYPE
...
__global__ void kernel0_3(float *A, int dimsize, int timestep, int I, int J, int c0)
{
#ifndef AN5D_TYPE
#define AN5D_TYPE unsigned
#endif
...
__global__ void kernel0_2(float *A, int dimsize, int timestep, int I, int J, int c0)
{
#ifndef AN5D_TYPE
#define AN5D_TYPE unsigned
#endif
...
__global__ void kernel0_1(float *A, int dimsize, int timestep, int I, int J, int c0)
{
#ifndef AN5D_TYPE
#define AN5D_TYPE unsigned
#endif
