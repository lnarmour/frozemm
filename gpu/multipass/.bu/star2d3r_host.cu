...
double kernel_stencil(SB_TYPE *A1, int compsize, int timestep, bool scop)
{
  ...
  if (scop) {
    if ((timestep >= 1 && pi >= 0 && pi <= 4194302 && dimsize >= 512 * pi + 1 && pj >= 0 && pj <= 4194302 && dimsize >= 512 * pj + 1) || (pj >= pi + 1 && pj <= 4194302 && dimsize + 3 * timestep >= 512 * pj + 4 && 512 * pj >= dimsize && ((-dimsize + 512 * pj) % 3) + dimsize + 512 * pi + 508 >= 512 * pj) || (dimsize >= 1 && pi <= 4194302 && dimsize + 3 * timestep >= 512 * pi + 4 && 512 * pi >= dimsize && pi >= pj && ((-dimsize + 512 * pi) % 3) + dimsize + 512 * pj + 508 >= 512 * pi)) {
...
#endif
      const AN5D_TYPE __c0Len = (timestep - max(max(0, 171 * pi - (dimsize + pi + 2) / 3 + 1), 171 * pj - (dimsize + pj + 2) / 3 + 1));
      const AN5D_TYPE __c0Pad = (max(max(0, 171 * pi - (dimsize + pi + 2) / 3 + 1), 171 * pj - (dimsize + pj + 2) / 3 + 1));
      #define __c0 c0
      const AN5D_TYPE __c1Len = (min(dimsize - 1, 512 * pi - 3 * c0 + 511) - 512 * pi - 3 * c0 + 1);
      const AN5D_TYPE __c1Pad = (512 * pi - 3 * c0);
      #define __c1 c1
      const AN5D_TYPE __c2Len = (min(dimsize - 1, 512 * pj - 3 * c0 + 511) - 512 * pj - 3 * c0 + 1);
      const AN5D_TYPE __c2Pad = (512 * pj - 3 * c0);
      #define __c2 c2
