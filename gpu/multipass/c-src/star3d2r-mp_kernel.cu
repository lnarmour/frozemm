...
#define AN5D_TYPE unsigned
    ...
    #define __CALCEXPR(__rn0, __a, __b, __c, __d, __e) do { __rn0 = (((((((((((((0.25F * (__REGREF(__c, 0, 0))) + (0.061999999F * (__REGREF(__b, 0, 0)))) + (0.0621000007F * (__REGREF(__d, 0, 0)))) + (0.0621999986F * (__SBREF(__c_sb, -1, 0)))) + (0.0623000003F * (__SBREF(__c_sb, 1, 0)))) + (0.0623999983F * (__SBREF(__c_sb, 0, -1)))) + (0.0624499992F * (__SBREF(__c_sb, 0, 1)))) + (0.0625500008F * (__REGREF(__a, 0, 0)))) + (0.0626000017F * (__REGREF(__e, 0, 0)))) + (0.0627000033F * (__SBREF(__c_sb, -2, 0)))) + (0.0627999976F * (__SBREF(__c_sb, 2, 0)))) + (0.0628999993F * (__SBREF(__c_sb, 0, -2)))) + (0.063000001F * (__SBREF(__c_sb, 0, 2)))); } while (0)
